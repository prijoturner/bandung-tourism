...
class SearchTableViewController: UITableViewController, UISearchBarDelegate,LKPullToLoadMoreDelegate {
    ...
    override func viewDidLoad() {
        ...
        offset = 0
        //        self.listDestination = Data.getObjectData(kListDestination) as! NSMutableArray
...
//        self.loadDataDestination()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        ////                                                cell.destinationImageView.image = newImage
        ////                                                cell.layoutIfNeeded()
        ////        })
...
//        })
        ...
        cell.destinationStaffPickButton.isHidden = true
    ...
    func searchBarTextDidEndEditing(_ searchBar: UISearchBar) {
        searhBar.setShowsCancelButton(false, animated: true)
    }
