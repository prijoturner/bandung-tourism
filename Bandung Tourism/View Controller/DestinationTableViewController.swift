...
class DestinationTableViewController: UITableViewController,LKPullToLoadMoreDelegate {
...
//        
//        // KingfisherManager.shared.cache disk cache. This is an async operation.
